...
from app.core.base_tags_schemas import BaseAlbum, BaseTrackTags
...
class ConsoleFormatResponse:
    ...
    def display_album_analysis_report(
        ...
        Muestra una tabla resumen con los metadatos agregados del álbum seguida
        de una tabla detallada con cada pista procesada.
